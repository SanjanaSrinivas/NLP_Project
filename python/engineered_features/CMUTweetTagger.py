...
RUN_TAGGER_CMD = "java -XX:ParallelGCThreads=2 -Xmx500m -jar ark-tweet-nlp-0.3.2.jar --model ritter_ptb.diff"
...
def check_script_is_present(run_tagger_cmd=RUN_TAGGER_CMD):
    ...
    try:
        ...
        print "Caught an OSError, have you specified the correct path to runTagger.sh? We are using {}. Exception: {}".format(run_tagger_cmd, repr(err))
    return success
